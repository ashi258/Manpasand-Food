...
const Items = () => {
  ...
  return (
    <div class="App_container__eSJ6i">
          ...
          <div class="carousel-inner" id="carousel">
            ...
            <div class="carousel-item active">
              <img
                ...
                class="d-block w-100"
                style={{ filter: "brightness(30%)", height: "535px" }}
                alt="..."
              />
            </div>
      ...
      <div class="PackageDetails_toolbar__3ztd1">
        <button class="Button_root__3ros1 Button_primary__I_9I9 Button_large__1i_fg Button_roundedMd__LOcFV ">
          Next
        </button>
